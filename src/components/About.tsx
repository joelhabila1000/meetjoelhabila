        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="animate-slide-in-left">
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              ...
              love for creating exceptional digital experiences. With over 3
              years of experience in web development, I specialize in building
              modern, responsive applications that not only look great but
              perform flawlessly.
            </p>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              My approach combines technical expertise with creative
              problem-solving, ensuring every project I work on delivers both
              aesthetic appeal and functional excellence. I believe in the power
              of clean code, intuitive design, and continuous learning.
            </p>
